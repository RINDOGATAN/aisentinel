...
- **Kit (self-hosted)**: the same app on your own hardware via Docker Compose, with no caps. Premium modules are sold only for the kit, at 60 a year each, and activated offline with a licence file. See [deploy/sovereign/README.md](deploy/sovereign/README.md).
