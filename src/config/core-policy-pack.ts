 ...
 * Art. 4 and Art. 5 apply since 2 Feb 2025 (Art. 4 in its amended wording, a
 * duty to SUPPORT the development of AI literacy, not to ensure a sufficient
 * level; the new Art. 5(1)(ba)/(bb) prohibitions from 2 Dec 2026); Art. 53
 * since 2 Aug 2025; Art. 50 since 2 Aug 2026 (marking grace to 2 Dec 2026 for
 * generative systems already on the market); Chapter III Sections 1-3 (the
 * high-risk classification and obligations) from 2 Dec 2027 for Annex III and
 * 2 Aug 2028 for Annex I. Arts. 73 and 86 were NOT deferred. GDPR Arts. 5, 6,
 * 9, 13-15, 22, 28, 33-35 and Chapter V; the 72-hour breach deadline is the
 * law in force (the 96-hour change is only a proposal). US state content is
 * deliberately conditional.
 *
 * EUR-Lex verified 2026-09-11 against OJ:L_202601744 and OJ:L_202401689.
 *
...
export const CORE_POLICY_PACK_VERSION = "2026.09.2";
  ...
  // ----------------------------------------------------------
  {
    ...
    content: withMarker({
      en: doc(
        ...
        "AI literacy",
        "Article 4 of the EU AI Act, applicable since 2 February 2025 and amended by Regulation (EU) 2026/1744 with effect from 27 July 2026, requires the organisation to take measures to support the development of AI literacy among its staff and other persons who operate or use AI systems on its behalf, taking into account their technical knowledge, experience, education and training, the context in which the systems are used and the persons on whom they are used. The article does not require the organisation to guarantee a particular level of literacy for any individual; the measures below are how it meets the duty. Each user completes the organisation's AI training before receiving access to an approved tool. The training covers the limits of the tools (including errors and invented content), confidentiality, data protection and this policy, and staff who oversee higher-risk systems receive further training for their role. Training is refreshed at least once a year and completion is recorded.",
      ...
      es: doc(
        ...
        "El artículo 4 del Reglamento de IA, aplicable desde el 2 de febrero de 2025 y modificado por el Reglamento (UE) 2026/1744 con efectos desde el 27 de julio de 2026, exige a la organización adoptar medidas para apoyar la promoción de la alfabetización en materia de IA de su personal y de las demás personas que se encarguen en su nombre del funcionamiento y la utilización de sistemas de IA, teniendo en cuenta sus conocimientos técnicos, su experiencia, su educación y su formación, el contexto de uso de los sistemas y las personas sobre las que se utilizan. El artículo no exige que la organización garantice un nivel específico de alfabetización de ninguna persona en particular; las medidas siguientes son la forma en que cumple este deber. Cada usuario completa la formación en IA de la organización antes de obtener acceso a una herramienta aprobada. La formación abarca los límites de las herramientas (incluidos los errores y el contenido inventado), la confidencialidad, la protección de datos y esta política, y el personal que supervisa sistemas de mayor riesgo recibe formación adicional para su función. La formación se actualiza al menos una vez al año y se deja constancia de su realización.",
  ...
  // ----------------------------------------------------------
  {
    ...
    content: withMarker({
      en: doc(
        ...
        "Where the organisation, as deployer, takes a decision on the basis of the output of a high-risk system listed in Annex III (other than the critical infrastructure systems in point 2 of that Annex) and the decision produces legal effects, or similarly significantly affects a person in a way that the person considers adverse to their health, safety or fundamental rights, Article 86 gives that person the right to a clear and meaningful explanation of the role of the AI system in the decision and of its main elements. The right applies only to the extent that Union law, such as the GDPR, does not already provide it. Article 86 was not deferred by Regulation (EU) 2026/1744 and has applied since 2 August 2026, while the rules that classify a system as high-risk under Annex III apply from 2 December 2027. The organisation answers any request for an explanation as it arises and will have a formal process in place before that date.",
      ...
      es: doc(
        ...
        "Cuando la organización, como responsable del despliegue, adopte una decisión basada en los resultados de salida de un sistema de alto riesgo enumerado en el anexo III (con excepción de los sistemas de infraestructuras críticas de su punto 2) y esa decisión produzca efectos jurídicos o afecte de manera igualmente significativa a una persona, de modo que esta considere que tiene un efecto perjudicial para su salud, su seguridad o sus derechos fundamentales, el artículo 86 reconoce a esa persona el derecho a obtener explicaciones claras y significativas del papel del sistema de IA en la toma de la decisión y de sus principales elementos. El derecho solo se aplica en la medida en que el Derecho de la Unión, como el RGPD, no lo reconozca ya. El Reglamento (UE) 2026/1744 no aplazó el artículo 86, que se aplica desde el 2 de agosto de 2026, mientras que las normas que clasifican un sistema como de alto riesgo conforme al anexo III se aplican a partir del 2 de diciembre de 2027. La organización atiende cualquier solicitud de explicación cuando se produzca y tendrá implantado un procedimiento formal antes de esa fecha.",
  ...
  // ----------------------------------------------------------
  {
    ...
    content: withMarker({
      en: doc(
        ...
        "Notification",
        "EU AI Act. For high-risk systems, providers report serious incidents under Article 73 to the market surveillance authorities of the Member State where the incident occurred, immediately after establishing a causal link (or its reasonable likelihood) and not later than 15 days after becoming aware of it; shorter limits apply where a person has died (10 days) and for a widespread infringement or a serious and irreversible disruption of the management or operation of critical infrastructure (2 days). Where timely reporting requires it, an incomplete initial report may be sent first and completed afterwards. Providers of systems for which the AI Office is exclusively competent under Article 75(1), as amended by Regulation (EU) 2026/1744, report to the AI Office instead. A deployer that identifies a serious incident must immediately inform first the provider, and then the importer or distributor and the relevant market surveillance authorities (Article 26(5)); if it cannot reach the provider, Article 73 applies to it. That deployer duty applies from 2 December 2027 for systems classified as high-risk under Annex III and from 2 August 2028 for those classified under Annex I (Article 113, as amended); the organisation already applies the same internal escalation to all its systems.",
      ...
      es: doc(
        ...
        "Notificación",
        "Reglamento de IA. En el caso de los sistemas de alto riesgo, los proveedores notifican los incidentes graves conforme al artículo 73 a las autoridades de vigilancia del mercado del Estado miembro en el que se haya producido el incidente, inmediatamente después de establecer un vínculo causal (o la probabilidad razonable de que exista) y, en todo caso, en un plazo máximo de 15 días desde que tengan conocimiento de él; se aplican plazos más breves en caso de fallecimiento de una persona (10 días) y en caso de infracción generalizada o de perturbación grave e irreversible de la gestión o el funcionamiento de infraestructuras críticas (2 días). Cuando sea necesario para notificar a tiempo, puede enviarse primero un informe inicial incompleto y completarlo después. Los proveedores de sistemas sobre los que la Oficina de IA tiene competencia exclusiva conforme al artículo 75, apartado 1, en la redacción dada por el Reglamento (UE) 2026/1744, notifican a la Oficina de IA. El responsable del despliegue que detecte un incidente grave debe informar inmediatamente, en primer lugar, al proveedor y, a continuación, al importador o distribuidor y a las autoridades de vigilancia del mercado pertinentes (artículo 26, apartado 5); si no puede contactar con el proveedor, se le aplica el artículo 73. Ese deber del responsable del despliegue se aplica a partir del 2 de diciembre de 2027 para los sistemas clasificados como de alto riesgo conforme al anexo III y del 2 de agosto de 2028 para los clasificados conforme al anexo I (artículo 113, en su versión modificada); la organización ya aplica el mismo procedimiento interno de escalado a todos sus sistemas.",
